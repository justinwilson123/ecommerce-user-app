...
import 'package:ecommerce/controller/myorder/shop/order_prepare_shop_controller.dart';
import 'package:ecommerce/core/class/viewhandlingdata.dart';
import 'package:ecommerce/core/constant/color.dart';

class OrderPrepareShopWidget extends GetView<OrderPrepareShopControllerImp> {
  const OrderPrepareShopWidget({super.key});

  @override
  Widget build(BuildContext context) {
    Get.put(OrderPrepareShopControllerImp());
    return Container(
      ...
      child: RefreshIndicator(
        ...
        child: ListView(
          children: [
            GetBuilder<OrderPrepareShopControllerImp>(
