...
import 'package:ecommerce/view/widget/myorder/oder_detail_items_and_rating_widget.dart';
import 'package:ecommerce/view/widget/myorder/order_detail_total_price_widget.dart';

class OrderDetailAndRatingScreen extends StatelessWidget {
  const OrderDetailAndRatingScreen({super.key});
      ...
      body: Container(
        ...
        child: GetBuilder<OrderDetailsCotrollerImp>(
          builder: (controller) => ViewHandLingData(
            ...
            widget: ListView(
              children: const [
                OderDetailItemsAndRatingWidget(),
                SizedBox(height: 10),
